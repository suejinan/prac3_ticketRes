...
<script>
	function searchKeyword(frm) { //동작x
	    var isDelete = confirm("검색 하시겠습니까?");
	    if (isDelete) {
...
<div>
	...
	<table class="table table-bordered">
		<tr>
			...
			<input class="btn btn-secondary" type="button" value="검색" onclick="searchKeyword(this.form)">	
			</td>
		</tr>
	</table>
	</div>
	...
	<h4>회원 관리 페이지</h4>
		...
		<c:forEach var="mem" items="${memberList }">
			<tr>
				...
				<td class="center">${mem.point }</td>
				<td><input class="btn btn-secondary" type="button" value="수정" onclick="javascript:location.href='updateMember.jsp'"></td>
