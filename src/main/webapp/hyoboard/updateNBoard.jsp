...
<div class="container">
	<h1>글 수정</h1>
	<hr>
	<form action="updateNBoard.do" method="post" name="updateform" onsubmit="return updatecheck();" >
	<input type="hidden" name="n_idx" value="${Nboard.n_idx}">
	<table>
		<tr>
			<th width="70">제목</th>
			<td><input type ="text" name="n_title" 
				value="${Nboard.n_title}"></td>
		</tr>
		<tr>
			<th>작성자</th>
			<td>${Nboard.id }</td>
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="40" cols="80" name="n_content">${Nboard.n_content}</textarea>  
			</td>
		</tr>
		<tr>
			<th>등록일</th>
