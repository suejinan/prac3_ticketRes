...
<div>
	...
	<h4>글 수정</h4>
		<tr>
			...
			<td><input style="width: 500px;" type="text" name="q_title" value="${board.q_title}">
			</td>
		</tr>
		<tr>
			<th>작성자</th>
		...
		<tr>
			<th>내용</th>
			<td><textarea style="width: 500px;" rows="10" cols="40" name="q_content">${board.q_content}</textarea></td>
		</tr>
		<tr>
			<th>등록일</th>
			<td>${board.regdate}</td>
		...
		<tr>
			<td><input class="btn btn-secondary" type="button" value="수정" onclick="updateBoard(this.form)"></td>
			<td><input class="btn btn-secondary" type="button" value="목록" onclick="javascript:location.href='getBoardList.jsp'"></td>
		</tr>
	</table>
	</div>
