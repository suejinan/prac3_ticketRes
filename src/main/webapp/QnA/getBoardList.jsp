...
<nav class="navbar navbar-expand-lg py-0">
	...
	<table class="table table-striped">
		<tr>
			...
			<th width="200" style="text-align: left;">제목</th>
			<th width="150" style="text-align: left;">작성자</th>
			<th width="150" style="text-align: left;">등록일</th>
			<th width="100" style="text-align: left;">조회수</th>
		</tr>
		<c:forEach var="board" items="${boardList }">
		<form>
		<tr>
			<td class="center">${board.q_idx }</td>
			<td>
				<a href="getBoard.do?q_idx=${board.q_idx }">
					${board.q_title }
				</a>
			</td>
			<td>${board.id }</td>
	...
	<c:if test="${sessionScope.userId != null }">
	<a class="btn btn-secondary" href="insertBoard.jsp">새 글 등록</a>
	</c:if>
