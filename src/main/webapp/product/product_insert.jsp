...
<script>
    ...
    function sendData() { //입력한 데이터 저장하기
       ...
       document.forms[0].action = "product_insert.do";
...
<body>
   ...
   <div id="container-table">
      <form action="product_insert.do" enctype="multipart/form-data" method="post">
         ...
         <table>
            ...
            <tr>
               <th>총 좌석</th>
               <td><input type="text" name="seat_max"></td>
            </tr>
            <tr>
               <th>잔여 좌석</th>
               <td><input type="text" name="seat_rest"></td>
            </tr>
