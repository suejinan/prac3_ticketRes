...
<body>
   ...
   <div class="container">
      <div class="row">
         <div class="col">
           <h2 style="margin: 20px;">공연정보</h2>
           <div class="cata" style="display: inline-block; margin-left: 10px; color: gray">
              ...
              <!-- 검색을 위한 폼 -->
          <form class="form-inline" action="product_list.do" method="post">
	...
	<div class="row">
		<div class="col">	
              <div class="list">
                 <c:choose>
                     <c:when test="${empty product_index }">
                               <h4>현재 등록된 공연이 없습니다.</h4>
                     </c:when>
                  <c:otherwise>
                  <c:forEach var="product" items="${product_index }">
